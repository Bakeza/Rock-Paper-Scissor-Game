...
function makeSelection(selection) {
    ...
    if (yourWinner === computerWinner) {
        ...
        finalResult.innerText = 'Player Choice : ' + selection.name + ' while Computer Choice : ' + computerSelection.name;
    }
    if (yourWinner) {
    ...
    if (computerWinner) {
        ...
        finalResult.innerText = 'Computer Choice : ' + computerSelection.name + ' while Player Choice : ' + selection.name;
    }
}
